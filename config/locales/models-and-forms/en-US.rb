	...
	:simple_form => {
		:hints => {
			...
			:call_log => {
				...
				:forwarded_to => "By whom the call was being forwarded",
				:sip_account_id => "Relation to SipAccount",
				:source => "Caller indentification number",
				:source_name => "Caller indentification name",
			...
			:global_contact => {
				...
				:phone_private => "Private phone numner",
			...
			:location => {
				:callid        => "Call ID header field value",
				:cflags        => "The contact flags",
				:contact       => "Contact header field value",
				:cseq          => "CSeq header field value",
				:domain        => "Domain name",
				...
				:user_agent    => "User agent header field value",
			...
			:oui => {
				...
				:value           => "OUI (Organizationally unique identifier) value",
			},
			:sip_proxy => {
			...
			:phone_key => {
				:label                             => "Text to be displayed beside the specific key",
				:phone_key_function_definition     => "Relation to the PhoneKeyFunctionDefinition",
				:phone_key_function_definition_id  => "Relation to PhoneKeyFunctionDefinition",
				:phone_model_key                   => "Relation to the PhoneModelKey",
			...
			:phone_key_to_function_mapping => {
				:phone_key_function_definition     => "Relation to PhoneKeyFunctionDefinition",
				:phone_key_function_definition_id  => "Relation to PhoneKeyFunctionDefinition",
				:phone_model_key                   => "Relation to PhoneModelKey",
				:phone_model_key_id                => "Relation to PhoneModelKey",
			},
			:phone_model => {
			...
			:phone_model_codec => {
				:codec          => "Relation to Codec",
				:codec_id       => "Relation to Codec",
				:phone_model    => "Relation to PhoneModel",
				:phone_model_id => "Relation to PhoneModel",
				:position       => "Position in list",
			},
			:phone_model_key => {
			...
			:pua => {
				...
				:extra_headers   => "Extra headers value",
				:flag            => "Flags value",
				:from_tag        => "From value",
				:pres_id         => "Presence ID value",
				:pres_uri        => "Presence URI value",
				:record_route    => "Record route value",
				:remote_contact  => "Remote contact value",
				:to_tag          => "To value",
				:tuple_id        => "Tuple ID value",
				:version         => "Version value",
				:watcher_uri     => "Watcher URI value",
			},
			:reboot_request => {
				:end        => "Date and time the reboot was finished",
				:phone      => "Relation to Phone",
				:phone_id   => "Relation to Phone",
			...
			:sip_account_to_extension => {
				:sip_account    => "Relation to SipAccount",
				:sip_account_id => "Relation to SipAccount",
				:extension      => "Relation to Extension",
				:extension_id   => "Relation to Extension",
				:position       => "Position in list",
			},
			:subscriber => {
				...
				:password          => "Password of the subsciber",
				:rpid              => "Remote party ID of the subsciber",
				:username          => "SIP-Username of the subsciber",
			},
			:version => {
