	...
	:activerecord => {
		...
		:attributes => {
			...
			:sip_gateway => {
				...
				:expire             => "Reg.-Dauer",
				:caller_id_patterns => "Anrufer-Nummer-Muster",
			},
			:user_to_extension => {
				:user          => "Benutzer",
				:user_id       => "Benutzer-ID",
	...
	:simple_form => {
		:hints => {
			...
			:sip_gateway => {
				...
				:caller_id_patterns => "Anrufer-Nummer-Muster um die Benutzer-Rufnummer herauszufinden",
			},
			:user_to_extension => {
				:user          => "",
				:user_id       => "",
