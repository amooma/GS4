	...
	:simple_form => {
		:hints => {
			...
			:call_log => {
				...
				:forwarded_to => "Durch wen wurde weitergeleitet",
				:sip_account_id => "Relation zu SipAccount",
				:source => "Nummer des Anrufers",
				:source_name => "Namen des Anrufers",
			...
			:location => {
				:callid        => "Call ID header Wert",
				:cflags        => "Contact Flags",
				:contact       => "Contact header Wert",
				:cseq          => "CSeq header Wert",
				:domain        => "Domain Name",
			...
			:oui => {
				...
				:value           => "OUI (Organizationally unique identifier) Wert",
			},
			:sip_proxy => {
			...
			:phone_key => {
				:label                             => "Text der neben der Taste angezeit wird",
				:phone_key_function_definition     => "Relation zu PhoneKeyFunctionDefinition",
			...
			:phone_model_codec => {
				:codec          => "Relation zu Codec",
				:codec_id       => "Relation zu Codec",
				:phone_model    => "Relation zu PhoneModel",
				:phone_model_id => "Relation zu PhoneModel",
				:position       => "Position in der Liste",
			},
			:phone_model_key => {
			...
			:pua => {
				...
				:extra_headers   => "Extra headers Wert",
				:flag            => "Flags Wert",
				:from_tag        => "From Wert",
				:pres_id         => "Presence ID Wert",
				:pres_uri        => "Presence URI Wert",
				:record_route    => "Record route Wert",
				:remote_contact  => "Remote contact Wert",
				:to_tag          => "To Wert",
				:tuple_id        => "Tuple ID Wert",
				:version         => "Version Wert",
				:watcher_uri     => "Watcher URI Wert",
			},
			:reboot_request => {
				:end        => "Zeitpunkt zu dem der Neustart beendet wurde",
				:phone      => "Relation zu Phone",
				:phone_id   => "Relation zu Phone",
			...
			:sip_account_to_extension => {
				:sip_account    => "Relation zu SipAccount",
				:sip_account_id => "Relation zu SipAccount",
				:extension      => "Relation zu Extension",
				:extension_id   => "Relation zu Extension",
				:position       => "Position in der Liste",
			},
			:subscriber => {
				...
				:domain            => "Domainname",
				:email_address     => "Email-Adresse des Subscriber",
				:ha1               => "Ha1 Hash-Wert",
				:ha1b              => "Ha1b Hash-Wert",
				:password          => "Password des Subsciber",
				:rpid              => "Remote party ID des Subsciber",
				:username          => "SIP-Benutzername des Subsciber",
			},
			:version => {
