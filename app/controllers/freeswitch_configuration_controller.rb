class FreeswitchConfigurationController < ApplicationController
	...
	def timezones()
		return {
			...
			"America/Argentina/ComodRivadavia" => "ART3ARST,M10.1.0/0,M3.3.0/0",
			...
			"America/Buenos_Aires" => "ART3ARST,M10.1.0/0,M3.3.0/0",
			...
			"Australia/Yancowinna" => "CST-9:30CST,M10.1.0,M4.1.0/3",
			"Brazil/Acre" => "ACT5",
