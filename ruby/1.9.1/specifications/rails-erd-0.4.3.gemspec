...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGES.rdoc", "Gemfile", "Gemfile.lock", "LICENSE", "README.md", "Rakefile", "VERSION", "lib/rails-erd.rb", "lib/rails_erd.rb", "lib/rails_erd/diagram.rb", "lib/rails_erd/diagram/graphviz.rb", "lib/rails_erd/diagram/templates/node.erb", "lib/rails_erd/domain.rb", "lib/rails_erd/domain/attribute.rb", "lib/rails_erd/domain/entity.rb", "lib/rails_erd/domain/relationship.rb", "lib/rails_erd/domain/relationship/cardinality.rb", "lib/rails_erd/domain/specialization.rb", "lib/rails_erd/railtie.rb", "lib/rails_erd/tasks.rake", "rails-erd.gemspec", "test/test_helper.rb", "test/unit/attribute_test.rb", "test/unit/cardinality_test.rb", "test/unit/diagram_test.rb", "test/unit/domain_test.rb", "test/unit/entity_test.rb", "test/unit/graphviz_test.rb", "test/unit/rake_task_test.rb", "test/unit/relationship_test.rb", "test/unit/specialization_test.rb"]
